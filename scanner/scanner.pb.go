...
func (x *ScanResults) GetHostResult() []*HostResult {
	if x != nil {
		return x.HostResult
	}
	return nil
...
var file_scanner_scanner_proto_rawDesc = []byte{
	...
	,
...
var file_scanner_scanner_proto_goTypes = []interface{}{
	...
	(*ScanResults)(nil), // 6: scanner.ScanResults
}
var file_scanner_scanner_proto_depIdxs = []int32{
	...
	5, // 3: scanner.ScanResults.host_result:type_name -> scanner.HostResult
	0, // 4: scanner.ScannerService.Scan:input_type -> scanner.Scanner
	1, // 5: scanner.ScannerService.GetScan:input_type -> scanner.Task
	6, // 6: scanner.ScannerService.Scan:output_type -> scanner.ScanResults
	6, // 7: scanner.ScannerService.GetScan:output_type -> scanner.ScanResults
...
type ScannerServiceClient interface {
	// Create new scanner
	Scan(ctx context.Context, in *Scanner, opts ...grpc.CallOption) (*ScanResults, error)
	// Fetch a previous scan result
	GetScan(ctx context.Context, in *Task, opts ...grpc.CallOption) (*ScanResults, error)
}
...
func (c *scannerServiceClient) Scan(ctx context.Context, in *Scanner, opts ...grpc.CallOption) (*ScanResults, error) {
	out := new(ScanResults)
...
func (c *scannerServiceClient) GetScan(ctx context.Context, in *Task, opts ...grpc.CallOption) (*ScanResults, error) {
	out := new(ScanResults)
...
type ScannerServiceServer interface {
	// Create new scanner
	Scan(context.Context, *Scanner) (*ScanResults, error)
	// Fetch a previous scan result
	GetScan(context.Context, *Task) (*ScanResults, error)
}
...
func (*UnimplementedScannerServiceServer) Scan(context.Context, *Scanner) (*ScanResults, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Scan not implemented")
}
func (*UnimplementedScannerServiceServer) GetScan(context.Context, *Task) (*ScanResults, error) {
