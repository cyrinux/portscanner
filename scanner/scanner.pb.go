...
var file_scanner_scanner_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x2e, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x05, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x22, 0x42,
	0x0a, 0x0a, 0x53, 0x63, 0x61, 0x6e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x34, 0x0a, 0x0b,
...
var file_scanner_scanner_proto_depIdxs = []int32{
	...
	5, // 7: scanner.ScannerService.GetScan:output_type -> scanner.HostResult
...
type ScannerServiceClient interface {
	...
	GetScan(ctx context.Context, in *Task, opts ...grpc.CallOption) (*HostResult, error)
}
...
func (c *scannerServiceClient) GetScan(ctx context.Context, in *Task, opts ...grpc.CallOption) (*HostResult, error) {
	out := new(HostResult)
...
type ScannerServiceServer interface {
	...
	// Fetch a previous scan result
	GetScan(context.Context, *Task) (*HostResult, error)
}
...
func (*UnimplementedScannerServiceServer) GetScan(context.Context, *Task) (*HostResult, error) {
